...
export default function MarketSection() {
    return (
        <section id="markets" className="relative h-[40dvh] xl:h-[80dvh] bg-white">
            ...
            />
            <div>
                <h2 className="absolute top-10 lg:top-20 left-10 lg:left-20 text-black text-4xl xl:text-6xl font-light text-left">
                    Regions We Operate
                </h2>
                <p className="mx-10 lg:mx-0 max-w-xl absolute bottom-10 lg:bottom-20 right-0 lg:right-20 text-2xl font-light text-black">
