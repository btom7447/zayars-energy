...
export default function EditPostModal({ post, onClose, refreshPosts }) {
    const [form, setForm] = useState({ 
        ...post,
        images: post.images || (post.imageUrl ? [post.imageUrl] : []), // migrate old posts
    });
    ...
    if (data.url) setForm((prev) => ({ ...prev, images: data.url }));
    setUploading(false);
  };
                ...
                <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto space-y-3 p-5">
                    ...
                    <div className="mb-5">
                        ...
                        <input 
                            ...
                            className="p-3 w-45 border border-gray-300 rounded-xl cursor-pointer"
                        />
                    ...
                    <div className="flex justify-end space-x-3">
                        <button
                            type="button"
                            onClick={onClose}
                            className="py-3 px-5 bg-gray-400 hover:bg-gray-700 text-white rounded-xl font-medium transition cursor-pointer"
                        >
                            Cancel
                        </button>
                        <button
